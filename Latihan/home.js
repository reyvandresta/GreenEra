// Array gambar yang akan digunakan dalam slideshow
var images = [
  "/Assets/msuemm 1 (2).png",
  "/Assets/star after.png",
  "/Assets/image4.jpg"
];
...
var transitionTime = 5000; // Ganti gambar setiap 5 detik

// Fungsi untuk mengganti gambar dengan animasi fade
function changeImage(index) {
  var slideshow = document.getElementById('slideshow');
  
  // Hilangkan gambar dengan transisi
